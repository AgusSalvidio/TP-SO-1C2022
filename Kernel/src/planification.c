...
void iniciar_planificador_corto_plazo() {
    ...
    log_info(process_execution_logger(),
             "Planificador de corto plazo creado correctamente utilizando el algoritmo '%s'.\n",
...
void iniciar_planificador_mediano_plazo() {
    ...
    log_info(process_execution_logger(),
             "Planificador de mediano plazo creado correctamente utilizando el algoritmo '%s'.\n",
             get_scheduling_algorithm());
}
